...
V této práci již nadále \uv{číslem} myslím číslo \textit{rekurzivní}. Jiným názvem této práce by tedy mohlo být \uv{Přesné výpočty s rekurzivními čísly}. V jistém smyslu tedy nesplním zadání, ale dokazatelně nejde počítat se \textit{všemi} reálnými čísly, nýbrž s jejich vlastní podmnožinou v podobě rekurzivních čísel.
